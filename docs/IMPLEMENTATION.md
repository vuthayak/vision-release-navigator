...
- **Non-goals for v2** (stay in [BACKLOG.md](BACKLOG.md)): `--repo` flag, open-ended prompts, GitHub API fallback, multi-release comparison.
...
- Idea you don't want to lose but isn't in v2 scope → [BACKLOG.md](BACKLOG.md).
